                    ...
                    <div className='w-full mx-auto card lg:w-1/2'>
                        <div className="flex flex-col p-5 mx-auto text-xl card-body">
                            ...
                            <div className="flex flex-row gap-5 mx-10 mt-3">
                                ...
                                <a href='https://app.netlify.com/teams/shourovhasan/overview' target="_blank" rel="noopener noreferrer" aria-label='Netlify'><img src='netlify.png' className='w-5 duration-300 ease-in-out hover:w-7' alt='' /></a>
